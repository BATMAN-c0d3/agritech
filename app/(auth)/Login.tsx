...
const Login = () => {
    ...
    return (
        <View style={{ flex: 1 }} className='bg-white justify-between'>
            <StatusBar translucent backgroundColor={'transparent'} barStyle={"light-content"} />
            <ImageBackground className='px-[2vh] pb-[2vh]' source={require("../../assets/images/authBgImage.png")} style={{ backgroundColor: "black" }}>
                <SafeAreaView>
